...
non_room_samples = [
    ...
    "End of Hallway",
    "Follow Signs", "Next Building", "Across the Street", "Up the Stairs",
    "Down the Hall",
    "Around the Corner", "Through the Door", "Past the Elevator",
    "Near the Exit",
    "Take Elevator", "Use Stairs", "Main Path", "Side Entrance", "Back Door",

    "Exit", "Emergency Exit", "Fire Exit", "Side Exit", "Back Exit",
    "North Exit",
    "South Exit", "East Exit", "West Exit", "Main Door", "Front Door",
    "Side Door",
    ...
    "HVAC Room",
    "Utility Room", "Utility Closet", "Storage Room", "Supply Closet",
    "Cleaning Closet",
    "Janitorial Supply", "Maintenance Room", "Equipment Room", "Server Room",
    "IT Closet",
    "Telecom Room", "Network Closet", "Panel Room", "Meter Room",

    "Mens Restroom", "Womens Restroom", "Family Restroom",
    "Accessible Restroom",
    ...
    "Lobby Area", "Waiting Area", "Seating Area", "Common Area",
    "Student Lounge",
    "Study Area", "Quiet Zone", "Group Study", "Break Room", "Kitchen Area",
    "Dining Area", "Food Court", "Snack Bar", "Vending Area",
    "Microwave Station",
    ...
    "Southwest",
    "Left", "Right", "Straight", "Forward", "Back", "Up", "Down", "Above",
    "Below",
    ...
    "Art Gallery", "Museum", "Exhibition Hall", "Display Case",
    "Bulletin Board",

    "Area", "Zone", "Section", "Department", "Division", "Unit", "Wing",
    "Block",
    "Complex", "Center", "Facility", "Location", "Destination", "Point", "Spot",
    "Place",

    "Under Construction", "Under Renovation", "Closed for Maintenance",
    "Out of Order",
    "Temporarily Closed", "Service Required", "Cleaning in Progress",
    "Wet Floor",
    "Caution", "Warning", "Danger", "Authorized Personnel Only",

    "WiFi Available", "Charging Station", "Power Outlet", "USB Port",
    "Network Access",
    "Internet Access", "Computer Terminal", "Kiosk", "Digital Display",
    "Monitor",

    "Fire Extinguisher", "Emergency Equipment", "AED", "First Aid Kit",
    "Safety Equipment",
    "Security Station", "Checkpoint", "Badge Reader", "Keypad",
    "Access Control",
    "Surveillance Area", "Monitored Zone", "Secure Area", "Restricted Zone",

    "Directory", "Map", "You Are Here", "Building Guide", "Floor Plan",
    "Legend",
    ...
    "Facility", "Service", "Resource", "Support", "Assistance",
    "Help Available",
